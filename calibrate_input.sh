...
# Input Calibration Runner
# Runs the calibration scene to determine controller input ranges
...
# Run the calibration scene
godot --scene scenes/calibration_scene.tscn
